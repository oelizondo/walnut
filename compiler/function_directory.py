class FunctionDirectory:
    ...
    def register_return_type(self, header, return_type, vm_direction):
         ...
         self.context.parent.variable_directory.register(return_type,header,None,vm_direction,None)
    ...
    def register_parameter(self, param_type, name, vm_direction):
        self.context.variable_directory.register(param_type,name,None,vm_direction,None)
